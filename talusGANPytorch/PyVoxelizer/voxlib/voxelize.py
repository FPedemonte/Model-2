...
def voxelize(file_path, resolution, progress_bar=None):
    ...
    vox = np.zeros((1,resolution,resolution,resolution), dtype=int)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default="E:/AI/medical/Implants/implants/talusGANPytorch/PyVoxelizer/voxlib/implant.stl")
